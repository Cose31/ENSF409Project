 ...
 * the creation of Animal objects of species "porcupine".
 * Inherits Animal.
 */
public class Porcupine extends Animal {

    /* MEMBERS */
    private final Feeding FEEDING = new Feeding(new int[]{19, 20, 21}, 5, 0);

    /* CONSTRUCTOR */
    public Porcupine(int animalID, String animalName) {
        super(animalID, animalName);
        
        this.setFeeding(this.FEEDING);
        this.setCleaningDuration(10);
    }
